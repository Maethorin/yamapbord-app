...
yamapBordControllers.controller('SelectedProjectKanbansController', ['$rootScope', '$scope', 'appConfig', 'Notifier', 'Alert', 'MeService', 'StoryService', 'HolidayService', 'ProjectStory', 'BacklogKanban', function($rootScope, $scope, appConfig, Notifier, Alert, MeService, StoryService, HolidayService, ProjectStory, BacklogKanban) {
